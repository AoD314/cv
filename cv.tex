...
\cventry{\textbf{June 2017 - Nov 2020}}
...
\section{Skills}
\cvline  {Languages}{python, bash, c/c++}
\cvline  {OS}{Linux, Windows, macOS}
\cvline  {Development technics}{\textbf{Agile:} TDD, Continuous Integration, XP, Scrum, Lean, Kanban}
\cvline  {VCS}{Git}
\cvline  {Tools}{vim, sublime text, cmake, ninja, gcc/clang, docker, k8s}
\cvline  {Frameworks}{opencv, tbb, cuda, opencl, postgresql, pytest}

\section{Optional skills}
\cvline {Languages}{HTML/JS, SQL, \LaTeX, Go, Rust}
